...
describe "#translate" do
  ...
  it "capitalizes capitalized words" do
    s = translate ("I Am Happy")
    s.should == "Iay Amay Appyhay"
  end

  it "retains punctuation from the original phrase" do
    s = translate("I am happy, excited, and amazing!")
    s.should == "Iay amay appyhay, exciteday, anday amazingay!"
  end
end
